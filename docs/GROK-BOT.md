...
| Sleep / wake-on-connect                                       | Fly suspends the Machine when idle; Bots sleep inside it too                                               | A routine whose minute passes while the Machine is suspended never fires                           |
